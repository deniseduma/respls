...
%optaus: K vector of alphau parameters selected via the BIC
%criterion
%optavs: K vector of alphav parameters selected via the BIC
%criterion
%optlus: K vector of lamu parameters selected via the BIC
%criterion
%optlvs: K vector of lamv parameters selected via the BIC
%criterion
