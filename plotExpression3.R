...
for (i in c(1,3,5)) {
	...
	pdf(paste("../data/cc/v3_noscale_top15_k6_v",iter,"/iter", iter, "_hmap",i,"_expr.pdf", sep=""))
	...
	hv<-heatmap.2(genesToPlotT,trace="none",scale="none",col=greenred(75), hclust = myHclustDist, main = paste("Treated samples, iter ", iter, " cluster ",i, sep="")) 
